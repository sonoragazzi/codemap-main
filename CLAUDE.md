...
Real-time pixel-art visualization of Claude Code and Windsurf agents. Shows agents as characters moving around a coworking space, working at desks that represent files.
...
| Client | `http://localhost:5173/coworking` |
...
3. **Agent Movement** (lines 670-730)
   ...
   - Idle agents go to break room after 30s
...
interface AgentCharacter {
  agentId: string;
  displayName: string;    // "Claude 1", "Claude Plan 1", "Windsurf 2", etc.
...
# 3. Open browser to http://localhost:5173/coworking
```
